  ...
  return (
    ...
    >
      ...
      {imgUrl && !imgError ? (
        ...
        <div className="text-gray-500 text-center flex flex-col items-center justify-center p-1 pointer-events-none">
          <svg
            className={`${
              containerSize.width < 120 || containerSize.height < 80 ? "w-5 h-5" : "w-12 h-12"
          ...
          {containerSize.width >= 120 && containerSize.height >= 80 && (
